...
public final class SslUtils {
    ...
    private static void __trustAllHostnames() {
        ...
        if (__hostnameVerifier == null) {
            __hostnameVerifier = new SslUtils._FakeHostnameVerifier();
        } // if
    ...
    private static void __trustAllHttpsCertificates() {
        ...
        if (__trustManagers == null) {
            __trustManagers = new com.sun.net.ssl.TrustManager[]{new SslUtils._FakeX509TrustManager()};
        } // if
    ...
    private static void _trustAllHostnames() {
        ...
        if (_hostnameVerifier == null) {
            _hostnameVerifier = new SslUtils.FakeHostnameVerifier();
        } // if
        // Install the all-trusting host name verifier:
    ...
    private static void _trustAllHttpsCertificates() {
        ...
        if (_trustManagers == null) {
            _trustManagers = new TrustManager[]{new SslUtils.FakeX509TrustManager()};
        } // if
        // Install the all-trusting trust manager:
        try {
